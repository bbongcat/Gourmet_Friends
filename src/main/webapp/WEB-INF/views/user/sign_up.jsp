            ...
            <div class="card-body">
                <form action="/user/sign_up" method="post" role="form" id="userCheck" name="user">
                    ...
                    <div class="form-group">
                        ...
                        <div class="check-font" id="pw-check"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="check-font" id="pw2-check"></div>
                    </div>

                    <div class="form-group">
                        <label for="userName">이름</label>
                        <input type="text" class="form-control" id="userName" name="userName" placeholder="NAME">
                        <div class="check-font" id="name-check"></div>
                    </div>

                    <div class="form-group">
                        <label for="userBirth">생년월일</label>
                        <input type="tel" class="form-control" id="userBirth" name="userBirth"
                               placeholder="ex)19990101">
                        <div class="check-font" id="birth-check"></div>
                    </div>

                    <div class="form-group">
                        <label for="userEmail">이메일 주소</label>
                        <input type="email" class="form-control" id="userEmail" name="userEmail" placeholder="E-mail">
                        <div class="check-font" id="email-check"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="check-font" id="phone-check"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="우편번호" name="userOaddress" id="userOaddress"
                               readonly>
                        <button type="button" class="btn btn-default" onclick='execPostCode();'><i
                                class="fa fa-search"></i>우편번호
                            찾기
                        </button>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="도로명 주소" name="userAddress" id="userAddress"
                               readonly>
                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="상세주소" name="userDetailaddress"
